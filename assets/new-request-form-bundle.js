import { r as reactExports, j as jsxRuntimeExports, F as Field, C as Combobox, O as Option, p as purify, u as useGrid, K as KEYS, s as styled, f as focusStyles, a as FauxInput, T as Tag, I as Input, b as useTranslation, c as Field$1, d as Tooltip, S as Span, e as SvgAlertWarningStroke, $ as $e, A as Anchor, M as Modal, g as getColor, h as SvgCheckCircleStroke, i as Accordion, P as Paragraph, B as Button, k as getColorV8, l as SvgSparkleFill, n as Avatar, D as Dots, o as FooterItem$2, H as Header$1, q as Body$2, t as Footer$2, v as Close$2, w as Alert, x as reactDomExports } from 'shared';
import { n as notify, i as initI18next, l as loadTranslations, T as ThemeProviders, c as createTheme } from 'ErrorScreen';
import { a as addFlashNotification, g as getVisibleFields, I as Input$1, D as DropDown, T as TextArea, R as RequestFormField, A as Attachments } from 'RequestFormField';
import { u as useModalContainer } from 'useModalContainer';
...
function GenerativeAnswerBotModalFooter({ isLoading, isError, isSubmittingFeedback, testId, onClose, onReject, onResolve, }) {
    ...
    if (isLoading) {
        return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(FooterItem$2, { children: jsxRuntimeExports.jsx(Button, { onClick: onClose, id: `${testId}-discard-button`, isBasic: true, children: t("new-request-form.answer-bot-generative-modal.buttons.close", "Close") }) }), jsxRuntimeExports.jsx(FooterItem$2, { children: jsxRuntimeExports.jsx(Button, { isPrimary: true, disabled: true, children: jsxRuntimeExports.jsx(Dots, { size: 24, color: "white" }) }) })] }));
    }
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [jsxRuntimeExports.jsx(FooterItem$2, { children: jsxRuntimeExports.jsx(Button, { onClick: onReject, id: `${testId}-reject-button`, isBasic: true, disabled: isSubmittingFeedback, children: t("new-request-form.answer-bot-generative-modal.buttons.still_need_help", "I still need help") }) }), jsxRuntimeExports.jsx(FooterItem$2, { children: jsxRuntimeExports.jsx(Button, { isPrimary: true, onClick: onResolve, id: `${testId}-resolve-button`, disabled: isSubmittingFeedback, children: t("new-request-form.answer-bot-generative-modal.buttons.this_helped", "This helped, solve my request") }) })] }));
}
...
function GenerativeAnswerBotModal({ requestId, hasRequestManagement, isSignedIn, helpCenterPath, requestsPath, requestPath, }) {
    ...
    return (jsxRuntimeExports.jsxs(Modal, { appendToNode: modalContainer, onClose: onClose, isLarge: true, children: [jsxRuntimeExports.jsx(Header$1, { children: modalState.isError
                    ? t("new-request-form.answer-bot-generative-modal.error.title", "An agent will be in touch soon")
                    : t("new-request-form.answer-bot-generative-modal.default.title", "Your request was submitted successfully") }), jsxRuntimeExports.jsx(Body$2, { children: jsxRuntimeExports.jsx(GenerativeAnswerBotModalBody, { isLoading: modalState.isLoading, isError: modalState.isError, generatedAnswer: modalState.generatedAnswer, citations: modalState.citations, testId: testId }) }), jsxRuntimeExports.jsx(Footer$2, { children: jsxRuntimeExports.jsx(GenerativeAnswerBotModalFooter, { isLoading: modalState.isLoading, isError: modalState.isError, isSubmittingFeedback: modalState.isSubmittingFeedback, testId: testId, onClose: onClose, onReject: onReject, onResolve: onResolve }) }), jsxRuntimeExports.jsx(Close$2, { "aria-label": t("new-request-form.answer-bot-generative-modal.close_modal_aria_label", "Close modal") })] }));
}
...
const Footer = styled.div `
  margin-top: ${(props) => props.theme.space.md};
`;
function NewRequestForm({ requestForm, wysiwyg, newRequestPath, parentId, parentIdPath, locale, baseLocale, hasAtMentions, userRole, userId, brandId, showSuggestedArticles, organizations, answerBotModal, }) {
    ...
    return (jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [parentId && (jsxRuntimeExports.jsx(StyledParagraph, { children: jsxRuntimeExports.jsx(Anchor, { href: parentIdPath, children: t("new-request-form.parent-request-link", "Follow-up to request {{parentId}}", {
                        ...
                        if (field.type === "subject") {
                            return (jsxRuntimeExports.jsxs(reactExports.Fragment, { children: [jsxRuntimeExports.jsx(Input$1, { field: field, onChange: (value) => handleChange(field, value) }), showSuggestedArticles && (jsxRuntimeExports.jsx(SuggestedArticles, { query: field.value, locale: locale }))] }, field.name));
                        }
                    ...
                    }), attachments_field && (jsxRuntimeExports.jsx(Attachments, { field: attachments_field, baseLocale: baseLocale, onAttachmentCountChange: (count) => {
                            ...
                            }, children: t("new-request-form.submit", "Submit") })) })] }), answerBotModalEnabled && (jsxRuntimeExports.jsx(AnswerBotModal, { authToken: answerBot.auth_token, interactionAccessToken: answerBot.interaction_access_token, articles: answerBot.articles, requestId: answerBot.request_id, ...answerBotModal })), answerBotGenerativeModalEnabled && (jsxRuntimeExports.jsx(GenerativeAnswerBotModal, { requestId: Number(answerBotGenerativeExperience.request_id), ...answerBotModal }))] }));
}
